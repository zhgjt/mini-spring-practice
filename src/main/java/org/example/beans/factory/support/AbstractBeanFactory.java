...
public abstract class AbstractBeanFactory extends DefaultSingletonBeanRegistry implements BeanFactory, BeanDefinitionRegistry {
    protected ConcurrentHashMap<String, BeanDefinition> beanDefinitions = new ConcurrentHashMap<>(256);
    private ConcurrentHashMap<String, Object> earlySingletonObjects = new ConcurrentHashMap<>(256);

    public void refresh() {
        //beanNames定义在DefaultSingletonBeanRegistry中
        ...
        if (singleton == null) {
            ...
            if (singleton == null) {
                ...
                if (initMethodName != null && !(initMethodName.equals(""))) {
                    invokeInitMethod(singleton, definition);
                }
                //step3:初始化后的逻辑
    ...
    private void invokeInitMethod(Object bean, BeanDefinition bd) {
        String methodName = bd.getInitMethodName();
        try {
